...
void transfer_litter(Patch& patch) {
	...
	while (patch.pft.isobj) {
		...
		if (date.day == 0)
		{
			pft.cmass_lost_bg = 0.0;
			pft.cmass_lost_cav = 0.0;
			pft.cmass_lost_greff = 0.0;


			pft.cmass_lost_heart_bg = 0.0;
			pft.cmass_lost_heart_greff = 0.0;
			pft.cmass_lost_heart_cav = 0.0;

			pft.cmass_lost_sap_bg = 0.0;
			pft.cmass_lost_sap_greff = 0.0;
			pft.cmass_lost_sap_cav = 0.0;

			pft.cmass_lost_leaf_bg = 0.0;
			pft.cmass_lost_leaf_greff = 0.0;
			pft.cmass_lost_leaf_cav = 0.0;

			pft.cmass_lost_root_bg = 0.0;
			pft.cmass_lost_root_greff = 0.0;
			pft.cmass_lost_root_cav = 0.0;
			...
			pft.npp_heart = 0.0;
			pft.npp_debt = 0.0;
			pft.litter_root_inc = 0.0;
			pft.litter_leaf_inc = 0.0;
		}
