...
// TODO running the code below is necessary! Otherwise seasonality.out is not filled properly!
// We need to call the function calc_seasonality(gridcell); for seasonality.out to be correct.
