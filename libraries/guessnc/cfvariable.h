...
public:
	...
	//Reduced data
#ifdef HAVE_SMARTIO
	std::vector<CoordI> get_all_coords() const;
#endif
	size_t get_n_stations() const;

	std::vector<double> get_all_lons() const;
	std::vector<double> get_all_lats() const;
