...
const double WILTING_POINT = -1.5; // MPa
...
public:
	...
	double kl_max;
    /// root tissue density (kg m-3) BEN M.
    double rtd;
...
public:
    ...
    double psi_L;
    /// minimum leaf water potential year-to-date
    double psi_L_min;
    /// Weighted Soil water potential [MPa]
    double psi_sw;
    /// minimum soil water potential year-to-date
    double psi_sw_min;
    /// Previous Weighted Soil water potential [MPa]
    double psi_sw_prev;
    /// Xylem water potential [MPa]
    double psi_xyl;
    /// minimum xylem water potential year-to-date
    double psi_xyl_min;
    ...
    /// If vpd is low, low diffusion rates for water
    bool low_diffusion_rate_w;
};
...
public:
	...
	/// return wcont for a certain layer
	double get_soil_water_frac(int layer) const;
...
public:
    ...
    void set_description(std::string basicString);
