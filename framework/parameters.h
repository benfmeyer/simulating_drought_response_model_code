...
// --> PPX-Hydraulics
typedef enum {STANDARD, MONTEITH_SUP_DEM, VPD_BASED_GC} hydraulicsystemtype;
// <-- PPX-Hydraulics
...
extern hydraulicsystemtype hydraulic_system;
extern bool disable_mort_greff;
extern double alphaa_nlim;
// <-- PPX-Hydraulics
...
/// Whether spinup data shall be detrended (default true)
extern bool ifdetrendspinuptemp;
...
#ifdef HAVE_SMARTIO
extern SmartOutputBuilderOptions so_options;
#endif 
